...
To perform Punto pago integration the commerce site must have installed KCC.
...
This module just perform conection to Punto pago in dev or prod enviroments. On this
...
Este módulo facilita la integración del método de pago Punto pago de Transbank con 
...
- Se registran todas las transacciones realizadas entre el comercio y Punto pago.
...
Para integrarse con Punto pago, el comercio debe tener instalado el sistema KCC de 
...
Para que el sistema de KCC pueda operar en el servidor del comercio, se necesita
 ...
 deshabilitados, en caso contrario puede no haber conexión con Punto pago. 
 Los parámetros son:
...
Este módulo sólo permite la conexión con Punto pago, sea en Certificación o en 
